        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Overview of QA scores, lead quality, and agent performance.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-sm text-muted-foreground">
                Use this page to chart QA scores over time, breakdowns by agent/campaign, and conversion metrics from
                QA-identified leads.
              </div>
            </CardContent>
          </Card>
